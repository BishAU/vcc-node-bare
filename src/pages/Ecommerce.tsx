...
const Ecommerce = () => {
  ...
  const mockOrders = [
    { id: 1, customer: 'John Doe', product: 'Premium Plan', status: 'Completed', amount: '$299.99', date: '2024-01-15' },
    { id: 2, customer: 'Jane Smith', product: 'Basic Plan', status: 'Processing', amount: '$149.99', date: '2024-01-14' },
    { id: 3, customer: 'Bob Johnson', product: 'Premium Plan', status: 'Pending', amount: '$299.99', date: '2024-01-13' },
  ];

  const [products, setProducts] = useState<Product[]>([
    { id: 1, name: 'Basic Plan', price: '$149.99', subscriptions: 245, revenue: '$36,747.55', active: true },
    { id: 2, name: 'Premium Plan', price: '$299.99', subscriptions: 183, revenue: '$54,898.17', active: true },
    { id: 3, name: 'Enterprise Plan', price: '$499.99', subscriptions: 72, revenue: '$35,999.28', active: true },
  ]);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              Manage your products, coupons, and subscriptions
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <p className="mt-2 text-3xl font-semibold text-gray-900">$127,645</p>
            <p className="mt-2 text-sm text-green-600">+12.5% from last month</p>
          </div>
          <div className="bg-white rounded-lg shadow p-6">
            <h3 className="text-sm font-medium text-gray-500">Active Subscriptions</h3>
            <p className="mt-2 text-3xl font-semibold text-gray-900">500</p>
            <p className="mt-2 text-sm text-green-600">+5.2% from last month</p>
          </div>
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <p className="mt-2 text-sm text-green-600">+8.1% from last month</p>
          </div>
          <div className="bg-white rounded-lg shadow p-6">
            <h3 className="text-sm font-medium text-gray-500">Churn Rate</h3>
            <p className="mt-2 text-3xl font-semibold text-gray-900">1.2%</p>
